...
<body>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle  text-white" type="button" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                 ...
                 <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                   <li><a class="dropdown-item " id="gg" href="web_develop.php">Website building and services</a></li>
                   <li><a class="dropdown-item " id="gg" href="internet_service.php">Internet FTTH services</a></li>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="4000">
      <img src="img/repair1.png" class="d-block h-50 w-100" alt="...">
                    <div class="carousel-caption   position-absolute top-50 start-50 translate-middle  "  data-aos="fade-up" data-aos-duration="500" >
                        <h5  style="color:white;background:blue;opacity:0.7;border-radius: 10px;" data-aos="fade-down"  data-aos-duration="50000">Finding solutions for your business and problems</h5>
                        <p style="color:white;background:blue;opacity:0.7;border-radius: 10px;" data-aos="fade-up"  data-aos-duration="50000" data-aos-delay="1000">Fast and Reliable solutions</p>
    ...
    <div class="carousel-item" data-bs-interval="5000">
      <img src="img/repair2.png" class="d-block h-50 w-100" alt="...">
      <div class="carousel-caption   position-absolute top-50 start-50 translate-middle "  >
                        <h5  style="color:white;background:blue;opacity:0.7;border-radius: 10px;" >Boost your Business</h5>
                        <p style="color:white;background:blue;opacity:0.7;border-radius: 10px;">Create Work Inspire</p>>
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="5000">
      <img src="img/repair3.png" class="d-block h-50 w-100" alt="...">
      <div class="carousel-caption   position-absolute top-50 start-50 translate-middle " >
